...
/*   Updated: 2024/12/20 08:32:39 by mvigara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// bonus/src/operations/checker_ops.c
...
void	checker_sa(t_stack **a, t_logger *log)
{
	swap(a);
	log_operation(log, "sa");
}

void	checker_sb(t_stack **b, t_logger *log)
{
	swap(b);
	log_operation(log, "sb");
}

void	checker_ss(t_stack **a, t_stack **b, t_logger *log)
{
	swap(a);
	swap(b);
...
int	execute_instruction(char *line, t_stack **a, t_stack **b, t_logger *log)
{
...
// ... Implementar el resto de operaciones de manera similar ...
...
/*   Updated: 2024/12/20 08:45:27 by mvigara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
